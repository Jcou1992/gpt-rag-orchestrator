...
3. **For details:** Read the actual playbook files (`../playbooks/01-preflight.md`, etc.)
...
3. Read: Individual playbooks (`../playbooks/`) if curious — 20 minutes
...
3. Read: The specific playbook you want to modify (`../playbooks/02-frontend-scaffold.md`, etc.)
4. Modify and test
5. Done!
...
Questions? Check SKILL_USAGE.md or the troubleshooting section in QUICK_START.md.
