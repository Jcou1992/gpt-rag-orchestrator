...
const cases = [
  ...
  },
  {
    ...
    expectedViolations: 95,                 // 89 (round-55) + 6 round-56 (3 quoted/computed obj-literal + 3 bracket property-assign)
    sentinels: [
      'STUB-JWT',
      'auth-stub-token',
      'dummy JWT',
      ...
      'localStorage-object-literal-value', // round-55 object-literal value
      'localStorage-property-assign',      // round-55 property/class-field assignment
    ],
  },
];
