...
**File:** `../playbooks/01-preflight.md` (~200 lines)
...
**File:** `../playbooks/02-frontend-scaffold.md` (~400 lines)
...
**File:** `../playbooks/03-backend-scaffold.md` (~350 lines)
...
**File:** `../playbooks/04-contract-tests.md` (~300 lines)
...
**File:** `../playbooks/05-docs-generation.md` (~500 lines)
...
**File:** `../playbooks/create-rag-app.md` (~250 lines, refactored)
...
**After:** Modular playbooks. `../guidelines.md` stays thin (~50 lines). Each sub-playbook is ~200–500 lines, focused context.
...
# Tell Junie: Follow ../playbooks/extract-reference-brief.md
...
```bash
cd <target-project>
# Tell Junie: Follow ../playbooks/create-rag-app.md
...
```bash
# Re-tell Junie: Follow ../playbooks/create-rag-app.md
...
- `../create-rag-app.md` — orchestrator, no longer monolithic

### Updated (pointers/instructions)
- `../guidelines.md` — playbook references, standing rules
- `../SKILL_USAGE.md` — usage instructions (three-step workflow, live progress tracking)
- `../extract-reference-brief.md` — minor tweaks (Language table)

### Created (new playbooks)
- `../playbooks/01-preflight.md` — decisions lock
- `../playbooks/02-frontend-scaffold.md` — Vue 3 code + tests
- `../playbooks/03-backend-scaffold.md` — Kotlin/Spring code + tests
- `../playbooks/04-contract-tests.md` — schemas + mocks + fallback docs
- `../playbooks/05-docs-generation.md` — 10+ comprehensive guides
...
1. **Review the skill:** Read `../guidelines.md` and `../SKILL_USAGE.md` to understand the new flow.

2. **Test it:** Tell Junie "Follow `../playbooks/create-rag-app.md`" and watch it scaffold the app.
...
Check:
- `../SKILL_USAGE.md` — how to use the skill
- `../guidelines.md` — standing rules
